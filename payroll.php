...
<style>
	...
	.btn-outline-primary{
		color: #f40be9 !important;
		border-color: #f40be9 !important;
	}
	#new_payroll_btn:focus, #new_payroll_btn:hover, .btn-outline-primary:hover {
			...
			<div class="col-lg-12">
				...
				<div class="card">
					<div class="card-header">
						...
						<button class="btn btn-primary btn-sm btn-block col-md-3 float-right add_btn" type="button" id="new_payroll_btn"><span class="fa fa-plus"></span> Add Payroll</button>
					</div>
					<div class="card-body">
